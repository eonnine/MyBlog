...
const Post: FunctionComponent<IBoardList> = ({ boardList }) => {
  ...
  const [ postBoard, { pdata } ] = useMutation(Queries.POST_BOARD);
  ...
  const [ patchBoard, { udata } ] = useMutation(Queries.PATCH_BOARD);
  ...
  return (
    <section>
      ...
      <ul className="actions">
        <li><a href="#" className="button" onClick={onClear}>새 글</a></li>
